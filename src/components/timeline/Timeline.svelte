...
<Timeline position="alternate">
	<TimelineItem>
		...
		<TimelineSeparator>
			...
			>
				<img src="https://img.icons8.com/nolan/64/taco.png" alt="logo" />
			</TimelineDot>
			<TimelineConnector />
		</TimelineSeparator>
	...
	<TimelineItem>
		...
		<TimelineSeparator>
			<TimelineDot
				style={'width: 45px; height: 45px; background-color: #fff; display: flex; justify-content: center; border-color: transparent; '}
			>
				<img src="https://img.icons8.com/doodle/48/000000/svetle.png" alt="logo" />
			</TimelineDot>
			<TimelineConnector />
		</TimelineSeparator>
	...
	<TimelineItem>
		...
		<TimelineSeparator>
			<TimelineDot
				style={'width: 45px; height: 45px; background-color: #fff; display: flex; justify-content: center; border-color: transparent; '}
			>
				<img src="https://img.icons8.com/nolan/64/birthday-cake.png" alt="otro" />
			</TimelineDot>
		</TimelineSeparator>
		<TimelineContent style={'height: 200px;'}>
			<h3>Snack</h3>
